/**
 * from: http://codepen.io/CapMousse/pen/EJaHk
 */
...
var livePatern = {
  ...
  cols: 0,
  rows: 0,
  colors: [230, 251, 249, 248, 241, 240],
  triangleColors: [],
  destColors: [],
  ...
  init: function(){
    ...
    this.canvas.width = document.getElementById('header').clientWidth;
    this.canvas.height = document.getElementById('header').clientHeight;
